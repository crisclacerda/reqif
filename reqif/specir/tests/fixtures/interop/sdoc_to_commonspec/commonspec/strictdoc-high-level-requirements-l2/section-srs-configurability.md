## Configurability @SECTION-SRS-Configurability

### REQUIREMENT: strictdoc.toml file @SDOC-SRS-37

> STATUS: Active

StrictDoc shall support a configuration of project-level options through a TOML file named `strictdoc.toml`.

### REQUIREMENT: Feature toggles @SDOC-SRS-39
...
### REQUIREMENT: 'Host' parameter @SDOC-SRS-119
