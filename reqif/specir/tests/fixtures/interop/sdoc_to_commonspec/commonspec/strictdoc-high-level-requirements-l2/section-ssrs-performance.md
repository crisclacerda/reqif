...
StrictDoc shall support incremental generation of documents. NOTE: \"Incremental\" means that only the modified documents are regenerated when StrictDoc is run repeatedly against the same project tree.
